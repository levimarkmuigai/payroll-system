 ...
 * Provides endpoints for employees to apply for leave and for HR to approve or
...
public class LeaveRecordController {
    ...
    public LeaveRecord applyForLeave(@RequestParam Long employeeId,
        ...
        return leaveRecordService.applyForLeave(employeeId, LocalDate.parse(startDate), LocalDate.parse(endDate),
                leaveType);
    }
